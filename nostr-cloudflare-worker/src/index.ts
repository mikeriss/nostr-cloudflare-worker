import { validateEvent, verifySignature, getSignature, getEventHash, getPublicKey, generatePrivateKey, nip19 } from 'nostr-tools'
...
export default {
	...
	async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
		console.log("xxx: ", nip19.decode('nsec1w7rsmvn9p7cer4qnz5ss38rqmapypfew4xd4hxr2l27r9krnvhqslz8rxg'))
